...
@app.route("/")
def dashboard():
    """หน้า Dashboard หลัก สำหรับ PROSUMER House E"""
    html_template = """
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>🏠 House E - PROSUMER Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏠 House E PROSUMER Dashboard</h1>
    ...
    <script>
        ...
        function initializeCountdown() {
            const savedCountdownStart = localStorage.getItem('houseE_countdownStart');
            const now = Date.now();
            ...
            if (savedCountdownStart) {
                ...
                localStorage.setItem('houseE_countdownStart', countdownStartTime.toString());
            }
        }
...
flask_thread.start()
print("🌐 Dashboard เริ่มทำงานที่ http://localhost:5006")
