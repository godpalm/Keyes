...
<head>
    ...
    <title>🏠 House B - Energy Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏠 House B Energy Dashboard</h1>
    ...
    <script>
        ...
        function initializeCountdown() {
            const savedCountdownStart = localStorage.getItem('houseB_countdownStart');
            const now = Date.now();
            ...
            if (savedCountdownStart) {
                ...
                localStorage.setItem('houseB_countdownStart', countdownStartTime.toString());
            }
        }
...
flask_thread.start()
print("🌐 Dashboard เริ่มทำงานที่ http://localhost:5001")
