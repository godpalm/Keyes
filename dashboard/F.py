...
<head>
    ...
    <title>🏠 House F - Energy Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏠 House F Energy Dashboard</h1>
    ...
    <script>
        ...
        function initializeCountdown() {
            const savedCountdownStart = localStorage.getItem('houseF_countdownStart');
            const now = Date.now();
            ...
            if (savedCountdownStart) {
                ...
                localStorage.setItem('houseF_countdownStart', countdownStartTime.toString());
            }
        }
...
flask_thread.start()
print("🌐 Dashboard เริ่มทำงานที่ http://localhost:5003")
